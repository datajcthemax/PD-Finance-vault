JSON(JavaScript Object Notation)은 [[데이터(Data)]]를 저장하고 교환하기 위한 경량의 데이터 형식입니다. JSON은 사람이 읽고 쓰기 쉬우며, 기계가 파싱하고 생성하기도 쉽기 때문에 웹 및 네트워크에서 데이터 교환의 표준 형식 중 하나로 널리 사용됩니다. JSON은 다음과 같은 주요 특징을 가집니다:
