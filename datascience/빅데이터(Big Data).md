빅데이터(Big Data)는 규모가 크고 다양한 유형의 [[데이터(Data)]] 집합을 나타내며, 기존 데이터 관리 및 분석 도구로는 처리하기 어려운 정도의 데이터 양을 가리킵니다. 빅데이터는 다양한 소스에서 발생하는 데이터를 수집, 저장, 분석하고, 그 중에서도 다음과 같은 세 가지 주요 특징을 갖습니다:
